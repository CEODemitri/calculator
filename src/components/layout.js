	...
	return(
		<div className = 'frame'>
			<div className = 'calculator'>
				...
				<img className='logo' src={logo} width="144px" alt="Demitri" style={{display: 'block', marginLeft: 'auto', marginRight: 'auto'}}/>
				<div className='keys'>
					...
					<input type='button' value={''} className='space'></input>
					...
					<input type='button' value={'='} className='button operator equalSign' onClick={handleClick}></input>
				</div>
			</div>
		</div>
	)
